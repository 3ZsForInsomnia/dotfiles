...
_G.packer_plugins = {
  ...
  ["neodev.nvim"] = {
    config = { "\27LJ\2\n\v\0\2\2\0\0\0\1K\0\1\0›\1\1\0\4\0\b\0\v6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\4\0005\3\3\0=\3\5\0023\3\6\0=\3\a\2B\0\2\1K\0\1\0\roverride\0\flibrary\1\0\2\14lspconfig\2\17setup_jsonls\2\1\0\4\fenabled\2\fplugins\2\fruntime\2\ntypes\2\nsetup\vneodev\frequire\0" },
    load_after = {},
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["nvim-cmp"] = {
    after = { "vim-dadbod-completion", "cmp-cmdline", "cmp-nvim-lsp-signature-help", "cmp-buffer", "cmp_luasnip", "cmp-nvim-lua", "cmp-ctags", "cmp-nvim-lsp-document-symbol", "cmp-path", "cmp-git", "cmp-treesitter", "cmp-nvim-tags", "cmp-emmet-vim" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'vim-matchup', 'hover.nvim', 'nvim-surround', 'lualine.nvim', 'undotree', 'nvim-lint', 'range-highlight.nvim', 'formatter.nvim', 'nvim-regexplainer', 'Comment.nvim', 'hlargs.nvim', 'gitsigns.nvim', 'LuaSnip', 'todo-comments.nvim', 'neogit', 'obsidian.nvim', 'neoscroll.nvim', 'marks.nvim'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
