...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-git", "cmp-cmdline", "cmp-emmet-vim", "cmp-nvim-lsp-signature-help", "cmp-treesitter", "cmp-ctags", "cmp-nvim-lua", "cmp-buffer", "cmp-path", "cmp-nvim-lsp-document-symbol", "cmp-nvim-tags", "cmp_luasnip", "vim-dadbod-completion" },
  ...
  ["nvim-dap"] = {
    after = { "vscode-js-debug", "telescope-dap.nvim", "nvim-dap-ui", "nvim-dap-vscode-js", "nvim-dap-virtual-text", "nvim-dap-python" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'LuaSnip', 'neoscroll.nvim', 'neogit', 'marks.nvim', 'vim-matchup', 'undotree', 'formatter.nvim', 'Comment.nvim', 'todo-comments.nvim', 'nvim-surround', 'nvim-lint', 'range-highlight.nvim', 'lualine.nvim'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
