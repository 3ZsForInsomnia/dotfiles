...
_G.packer_plugins = {
  ...
  ["neodev.nvim"] = {
    config = { "\27LJ\2\n\v\0\2\2\0\0\0\1K\0\1\0›\1\1\0\4\0\b\0\v6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\4\0005\3\3\0=\3\5\0023\3\6\0=\3\a\2B\0\2\1K\0\1\0\roverride\0\flibrary\1\0\2\17setup_jsonls\2\14lspconfig\2\1\0\4\fenabled\2\ntypes\2\fruntime\2\fplugins\2\nsetup\vneodev\frequire\0" },
    load_after = {},
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp-signature-help", "cmp-treesitter", "cmp_luasnip", "cmp-nvim-lsp-document-symbol", "cmp-emmet-vim", "cmp-nvim-lua", "cmp-git", "cmp-nvim-tags", "cmp-path", "cmp-ctags", "cmp-cmdline", "cmp-buffer", "vim-dadbod-completion" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-vscode-js", "telescope-dap.nvim", "nvim-dap-ui", "vscode-js-debug", "nvim-dap-python", "nvim-dap-virtual-text" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["nvim-lightbulb"] = {
    ...
    loaded = true,
    path = "/Users/zachary/.local/share/nvim/site/pack/packer/start/nvim-lightbulb",
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-lint', 'Comment.nvim', 'LuaSnip', 'range-highlight.nvim', 'todo-comments.nvim', 'gitsigns.nvim', 'lualine.nvim', 'undotree', 'vim-matchup', 'formatter.nvim', 'marks.nvim', 'nvim-surround'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
