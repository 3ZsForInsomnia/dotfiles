...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "vim-dadbod-completion", "cmp-git", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp-signature-help", "cmp-nvim-lsp-document-symbol", "cmp-ctags", "cmp-path", "cmp-nvim-lua", "cmp_luasnip", "cmp-nvim-tags", "cmp-treesitter", "cmp-emmet-vim" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-ui", "telescope-dap.nvim", "nvim-dap-vscode-js", "nvim-dap-virtual-text", "nvim-dap-python", "vscode-js-debug" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["silicon.nvim"] = {
    ...
    loaded = true,
    path = "/Users/zachary/.local/share/nvim/site/pack/packer/start/silicon.nvim",
...
try_loadstring("\27LJ\2\n7\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\nsetup\14code-shot\frequire\0", "config", "code-shot.nvim")
time([[Config for code-shot.nvim]], false)
-- Config for: silicon.nvim
time([[Config for silicon.nvim]], true)
try_loadstring("\27LJ\2\nE\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\nsetup\28config.code-screenshots\frequire\0", "config", "silicon.nvim")
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'marks.nvim', 'range-highlight.nvim', 'lualine.nvim', 'hover.nvim', 'formatter.nvim', 'hlargs.nvim', 'todo-comments.nvim', 'gitsigns.nvim', 'LuaSnip', 'nvim-regexplainer', 'nvim-surround', 'nvim-lint', 'Comment.nvim', 'obsidian.nvim', 'neogit', 'neoscroll.nvim', 'vim-matchup', 'undotree'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
