...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lsp-signature-help", "cmp-emmet-vim", "cmp_luasnip", "cmp-nvim-lua", "cmp-nvim-lsp-document-symbol", "vim-dadbod-completion", "cmp-treesitter", "cmp-nvim-tags", "cmp-path", "cmp-ctags", "cmp-cmdline", "cmp-git" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-virtual-text", "nvim-dap-python", "vscode-js-debug", "nvim-dap-ui", "telescope-dap.nvim", "nvim-dap-vscode-js" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'neoscroll.nvim', 'nvim-regexplainer', 'lualine.nvim', 'nvim-lint', 'hlargs.nvim', 'vim-matchup', 'gitsigns.nvim', 'formatter.nvim', 'range-highlight.nvim', 'hover.nvim', 'nvim-surround', 'LuaSnip', 'todo-comments.nvim', 'obsidian.nvim', 'Comment.nvim', 'marks.nvim', 'undotree', 'neogit'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
