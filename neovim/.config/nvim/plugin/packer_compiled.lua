...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-git", "cmp-emmet-vim", "cmp-treesitter", "cmp-ctags", "cmp-nvim-lua", "cmp-path", "cmp-nvim-lsp-document-symbol", "cmp_luasnip", "cmp-nvim-tags", "cmp-buffer", "cmp-nvim-lsp-signature-help", "vim-dadbod-completion" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-python", "nvim-dap-ui", "nvim-dap-vscode-js", "vscode-js-debug", "telescope-dap.nvim", "nvim-dap-virtual-text" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'neoscroll.nvim', 'neogit', 'LuaSnip', 'nvim-surround', 'lualine.nvim', 'nvim-lint', 'range-highlight.nvim', 'formatter.nvim', 'undotree', 'todo-comments.nvim', 'marks.nvim', 'vim-matchup', 'Comment.nvim'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
