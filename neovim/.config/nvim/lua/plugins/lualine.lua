...
return {
  {
    ...
    config = function()
      require("lualine").setup({
        ...
        sections = {
          lualine_a = {
            { "b:gitsigns_head", color = { fg = "#000000" } },
          },
          lualine_b = {
            {
              "diagnostics",
...
--
--
-- Old project-level git status polling code
--
--
...
--
-- Old Lualine to initiate project-level git status polling
--
...
--
-- Old Lualine status lualine_b items
--
