...
M.Panes = {
  ...
  { key = "s", mods = "ALT", action = action({ ActivatePaneDirection = "Down" }) },
  {
    key = 'H',
    mods = 'ALT',
  ...
  { key = 'a', mods = 'ALT', action = action.ActivatePaneByIndex(0) },
  { key = 'b', mods = 'ALT', action = action.ActivatePaneByIndex(1) },
  { key = 'c', mods = 'ALT', action = action.ActivatePaneByIndex(2) },
  { key = 'd', mods = 'ALT', action = action.ActivatePaneByIndex(3) },
  { key = 'e', mods = 'ALT', action = action.ActivatePaneByIndex(4) },
  { key = 'f', mods = 'ALT', action = action.ActivatePaneByIndex(5) },
